...
## Περιγραφή 5ης άσκησης όπως αναγράφεται από τον διδάσκοντα στο gunet2:

**1) Να κατασκευαστεί ένα αρχείο ldif το οποίο θα αναπαριστά την δομή ενός ldap server, ο οποίος περιλαμβάνει τα στοιχεία προσωπικού για το Τμήμα Πληροφορικής του Πανεπιστημίου. Τα στοιχεία θα προέρχονται από τον κατάλογο προσωπικού(http://www.unipi.gr/unipi/el/plh-dep-all.html) του ιστοτόπου της σχολής. Από τον παραπάνω κατάλογο προσωπικού, να εισαγάγετε στον ldap server σας 5 τυχαίες εγγραφές (καθηγητές) με τα αντίστοιχα χαρακτηριστικά τους, όπως φαίνεται στην παρακάτω δομή:**
...
Σημ: Ακολουθώντας τα βήματα που δείξαμε στο εργαστήριο μπορείτε να κάνετε export το δέντρο που δημιουργήσατε μέσα από το phpldapadmin. 




**2) Να κατασκευαστεί ένα δεύτερο αρχείο ldif το οποίο θα αναπαριστά την δομή ενός ldap server ο οποίος θα περιλαμβάνει τους ρόλους και τους χρήστες που θα χρησιμοποιηθούν στην τελική εργασία σας. Ενδεικτικά: εάν η τελική εργασία σας αφορά μία υπηρεσία Online έκδοσης λογαριασμών τηλεφωνίας, οι ρόλοι που θα περιλαμβάνονται μπορεί να είναι: Πελάτης, Πωλητής, Διαχειριστής εφαρμογής.**




**3) Στην τελική σας εργασία μπορεί προαιρετικά να γίνεται η αυθεντικοποίηση και η εξουσιοδότηση των χρηστών της εφαρμογής σας μέσω του ldap server που δημιουργήσατε στο προηγούμενο βήμα. Υλοποιήστε τα παρακάτω βήματα:**

Διασύνδεση της εφαρμογής σας με τον ldap server, ανάλογα με την γλώσσα προγραμματισμού και το περιβάλλον υλοποίησης της αρεσκείας σας έχοντας ως οδηγό τo αντίστοιχο εργαστηριακό παράδειγμα και τις σχετικές σημειώσεις.

     -Χρήση του LDAP για την εγγραφή (signup) των χρηστών

     -Χρήση του LDAP για την είσοδο (login) των χρηστών 

     -Χρήση του LDAP για την αλλαγή κωδικού πρόσβασης (password) των χρηστών.


**Σημείωση: Τα δύο πρώτα βήματα θα παραδοθούν σε αυτή την άσκηση, ενώ το 3ο βήμα είναι προαιρετικό και μπορεί να υλοποιηθεί/παραδοθεί στην τελική εργασία.**
